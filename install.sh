...
echo "   ~/.aegis/aegis.py, so core Observer checks work with NO Full Disk Access."
echo "   Capability-dependent sensors (including BTM) report DEGRADED when denied."
echo "   Do not give /usr/bin/python3 Full Disk Access:"
